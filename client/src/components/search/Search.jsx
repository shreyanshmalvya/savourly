...
const Search = () => {
    ...
    useEffect(() => {
        ...
        if (search) {
            const result = async () => {
                const response = await axios.get(`https://git.heroku.com/savourly-v1.git/recipe/${search}`);
    ...
    useEffect(() => {
        const result = async () => {
            const response = await axios.get(`https://git.heroku.com/savourly-v1.git/recipe/`);
